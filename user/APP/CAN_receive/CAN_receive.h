...
typedef enum
{
    ...
    CAN_3508_M4_ID = 0x204,
	  ...
	  CAN_SHOOT_REVOLVER_ID = 0x205,
	  CAN_SHOOT_LEFT_ID = 0x206,
	  CAN_SHOOT_RIGHT_ID = 0x207,
...
//发送摩擦轮和拨盘电机指令
extern void CAN_CMD_SHOOT(int16_t shoot_left, int16_t shoot_right, int16_t revolver, int16_t none);
